...
namespace sx {
	...
	namespace dialog_item {
		...
		enum item_flag {
			...
			flexible_height	= 0x2000,	// \en blah \enden \ja アイテムの縦幅が可変になることを許可する\endja
			flexible_width	= 0x4000,	// \en blah \enden \ja アイテムの横幅が可変になることを許可する\endja
		};
	}
	...
	enum dialog_item_id {
		...
		idprofile = 5,	// \en blah \enden \ja プロファイルボタン \endja
	};
	...
	enum mouse_cursor_enum {
		...
		cursor_grab_hand,
		cursor_zoom_in_out,		// \en A zoom icon. \enden \ja 拡大カーソル \endja
		cursor_paint,			// \en A zoom icon. \enden \ja ペイントカーソル \endja
		cursor_paint_plus,
		cursor_paint_minus,
		cursor_paint_minimum,
		cursor_paint_maximum,
//		cursor_paint_smooth,
		cursor_drag_panel_prohibited,
		cursor_camera,
