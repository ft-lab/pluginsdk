...
namespace sxsdk {
	...
	public:
		...
		/// \en The flag of horizontal scrollable.\enden \ja 横スクロール可フラグ。\endja 
			table_style_scroll_horizontal = 0x0010,
		/// \en The flag of inline number editable.\enden \ja 数字のインライン編集フラグ。\endja
			table_style_inline_number_edit = 0x0020,
		/// \en The flag of single row selection.\enden \ja 選択なし状態を許すフラグ。\endja 
