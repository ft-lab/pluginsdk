...
#pragma clang diagnostic ignored "-Wold-style-cast"
	...
	virtual int get_subdivision_level (void* = nullptr) const = 0; // 0
	virtual loader_info_interface &set_subdivision_level (int subdivision_level_param, void* = nullptr) = 0; // 1
	...
	virtual bool get_active (void* = nullptr) const = 0; // 10
	virtual bool get_render (void* aux = 0) = 0; // 11
	virtual int get_rendering_flag (void* = nullptr) const = 0; // 12
