...
#pragma clang diagnostic ignored "-Wold-style-cast"
	...
	virtual background_interface &set_lighting_intensity_factor (float lighting_intensity_factor_param, void* = nullptr) = 0; // 27
	virtual float get_lighting_intensity_factor (void* = nullptr) const = 0; // 28
	...
	virtual int get_active_layer (void* = nullptr) const = 0; // 32
	virtual background_interface &set_active_layer (int active_layer_param, void* = nullptr) = 0; // 33
	virtual sxsdk::rgb_class get_upper_base_color (void* = nullptr) const = 0; // 34
	virtual background_interface &set_upper_base_color (const sxsdk::rgb_class &upper_base_color_param, void* = nullptr) = 0; // 35
	virtual sxsdk::rgb_class get_lower_base_color (void* = nullptr) const = 0; // 36
	virtual background_interface &set_lower_base_color (const sxsdk::rgb_class &lower_base_color_param, void* = nullptr) = 0; // 37
	virtual int get_number_of_background_layers (void* = nullptr) const = 0; // 38
